...
import '../../UI/assets/scss/FooterPlayer.scss';
...
import ControlsToggleButton from "../music/ControlsToggleButton";
import Name from "../healpers/Name";
import {ThemeContext} from "../../Store/db/Theme";
import {useDispatch, useSelector} from "react-redux";
import {setBannerOpen, setCurrentPlaying} from "../../Store/actions/actions";
...
function FooterMusicPlayer({music}) {
    ...
    return (
        <div style={useStyle.musicFooter} className={"footer-player"}>
            ...
            <Button
                    startIcon={<Avatar variant="square" src={require("./../../UI/assets/img/" + img)} alt={name}/>}
            ...
            <div className="playback-controls">
                ...
                <audio ref={audioElement} src={require("./../../UI/assets/music/" + musicName)} preload={"metadata"}/>
